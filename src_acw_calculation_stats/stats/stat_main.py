# Statistics
from analysis_codebase.src.stats.stat_utils import calculate_descriptive_statistics, check_normality, perform_two_way_welch_anova, perform_post_hoc_tests

hc_data_path = 'analysis_codebase/results/acw_results_2_archive/mean_acw_results_HC.csv'
mdd_data_path = 'analysis_codebase/results/acw_results_2_archive/mean_acw_results_MDD.csv'
sz_data_path = 'analysis_codebase/results/acw_results_2_archive/mean_acw_results_SZ.csv'
...
for group, data_path in [('HC', hc_data_path), ('MDD', mdd_data_path), ('SZ', sz_data_path)]:
    for acw_measure in [acw_measure]:
        if group == 'HC':
            stats = calculate_descriptive_statistics(data_path, acw_measure, output_folder_desc_stats, subjects_to_remove=['sub-005C'])
        elif group == 'MDD':
            stats = calculate_descriptive_statistics(data_path, acw_measure, output_folder_desc_stats, subjects_to_remove=['sub-004P', 'sub-035P', 'sub-051P'])
